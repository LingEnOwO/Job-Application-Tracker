...
import { formatDateForDisplay, formatDateToISO } from "../services/utils.js";
 ...
 */
export function renderSidePeek(
  application,
  onUpdate,
  onClose,
  mode = "edit",
  ...
  if (header) {
    header.textContent =
      mode === "create" ? "New Application" : "Application Details";
  }
    ...
    <div class="detail-group">
      ...
      <div class="detail-value">
        <select id="edit-stage">
          ...
          <option value="Interview" ${application.stage === "Interview" ? "selected" : ""}>Interview</option>
